...
1. [서비스 소개](#서비스-소개)
2. [주요 기능](#주요-기능)
    - [모임 및 일정 탐색](#모임-및-일정-탐색)
    - [유저 기능](#유저-기능)
    - [마이페이지](#마이페이지)
3. [프로젝트 기간](#프로젝트-기간)
4. [협업 및 커뮤니케이션](#협업-및-커뮤니케이션)
5. [프로젝트 환경](#프로젝트-환경-기술-스택)
6. [서비스 아키텍처](#서비스-아키텍처)
7. [ERD](#erd)
8. [API 명세](#api-명세)
...
- 기획 및 서비스 기능 정리 : 12.23 ~ 01.06
- ERD 및 API 명세 작업 : 01.04 ~ 01.07
- 1차 MVP 개발 : 01.02 ~ 01.20
- 백엔드 서버 배포 : 01.14
- 기능 수정 및 리팩토링 : 01. 14 ~ 01.30
- Github Actions CI 환경 구축 : 01.27
- 2차 기획 및 기능 논의 : 01.24 ~ 01.31
- Blue-Green 배포 및 CD 파이프 라인 도입 : 02.07
- 2차 MVP 개발 : 02.07 ~ 02.12
...
| Stack                                                                                                        |     Version     |
|:------------------------------------------------------------------------------------------------------------:|:---------------:|
| ![Spring](https://img.shields.io/badge/spring-%236DB33F.svg?style=for-the-badge&logo=spring&logoColor=white) | Spring Boot 3.4 |
| ![Gradle](https://img.shields.io/badge/Gradle-02303A.svg?style=for-the-badge&logo=Gradle&logoColor=white)    |   Gradle 8.12   |
...
| ![Redis](https://img.shields.io/badge/redis-%23DD0031.svg?style=for-the-badge&logo=redis&logoColor=white)    |    Redis 7.4    |
...
## ⛓️ ![ERD](https://dbdiagram.io/d/WeMo-677210785406798ef7e37c0d)
